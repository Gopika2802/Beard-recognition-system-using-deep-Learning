...
##auth_token = 'a52fb9b3e7faa1dba0e2406ec8c7d1ec'
##account_sid = 'AC0b87052e5079dbb663f8ea15557d147f'
##client1 = Client(account_sid, auth_token)
##def sms():
##    message = client1.messages \
##              .create(
##                  body='ANIMAL IS DETECTED and YOUR LONGITUDE AND LATITITUDE VALUE IS {}'.format(b),
##                  from_='+15076903542',
##                  to = '+916381124158'
##                  )
##    print(message.sid)
